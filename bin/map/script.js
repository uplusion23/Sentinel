...
function fantasyMap() {
  ...
  function generate() {
    ...
    setTimeout(function() {
      var defaultMapObj = require('fs').readFileSync('map/map.map', 'utf8');
      defaultMapObj = defaultMapObj.split("\r\n");
      loadDataFromMap(defaultMapObj);
      $('body').css({'opacity': 1})
      window.enableMap();
     //cleanData();
    }, 5000);
...
// Heighmap Template: Low Island
  ...
  function changeDialogsTransparency(v) {
    ...
    const optionsColor = "rgba(38, 40, 42, " + alpha + ")"; // purple-red
